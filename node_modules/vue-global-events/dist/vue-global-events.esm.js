/*!
  ...
  * @license MIT
  */
import { defineComponent, ref, onActivated, onDeactivated, onMounted, onBeforeUnmount } from 'vue';
    ...
    setup(props, { attrs }) {
        ...
        onMounted(() => {
            Object.keys(attrs)
                ...
                if (!match) {
                    {
                        console.warn(`[vue-global-events] Unable to parse "${eventNameWithModifiers}". If this should work, you should probably open a new issue on https://github.com/shentao/vue-global-events.`);
                    }
                    return;
                }
